...
[![下载安装器](https://github.com/IvanMurzak/Unity-MCP/blob/main/docs/img/button/button_download.svg?raw=true)](https://github.com/IvanMurzak/Unity-MCP/releases/download/0.52.0/AI-Game-Dev-Installer.unitypackage)
...
- **[⬇️ 下载安装器](https://github.com/IvanMurzak/Unity-MCP/releases/download/0.52.0/AI-Game-Dev-Installer.unitypackage)**
- **📂 将安装器导入 Unity 项目**
  > - 双击文件 — Unity 将自动打开它
