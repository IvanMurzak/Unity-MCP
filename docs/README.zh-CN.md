...
[![下载安装程序](https://github.com/IvanMurzak/Unity-MCP/blob/main/docs/img/button/button_download_zh-CN.svg?raw=true)](https://github.com/IvanMurzak/Unity-MCP/releases/download/0.46.2/AI-Game-Dev-Installer.unitypackage)
...
- **[⬇️ 下载安装程序](https://github.com/IvanMurzak/Unity-MCP/releases/download/0.46.2/AI-Game-Dev-Installer.unitypackage)**
- **📂 将安装程序导入Unity项目**
  > - 您可以双击文件 - Unity会自动打开它
