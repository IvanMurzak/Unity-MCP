...
[![DOWNLOAD INSTALLER](https://github.com/IvanMurzak/Unity-MCP/blob/main/docs/img/button/button_download.svg?raw=true)](https://github.com/IvanMurzak/Unity-MCP/releases/download/0.46.3/AI-Game-Dev-Installer.unitypackage)
...
- **[⬇️ Download Installer](https://github.com/IvanMurzak/Unity-MCP/releases/download/0.46.3/AI-Game-Dev-Installer.unitypackage)**
