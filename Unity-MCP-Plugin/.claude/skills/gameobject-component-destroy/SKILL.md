...
> For complex input (multi-line strings, code), save the JSON to a file and use `npx unity-mcp-cli run-tool gameobject-component-destroy --input-file args.json`.
