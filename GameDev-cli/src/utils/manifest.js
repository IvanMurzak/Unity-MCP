...
export const MANIFEST_RELATIVE_PATH = path.join('Packages', 'manifest.json');

export const PACKAGE_ID = 'com.ivanmurzak.unity.mcp';
export const REGISTRY_NAME = 'package.openupm.com';
export const REGISTRY_URL = 'https://package.openupm.com';
