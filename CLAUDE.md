...
Version is sourced from [Unity-MCP-Plugin/Packages/AI-Game-Developer/package.json](Unity-MCP-Plugin/Packages/AI-Game-Developer/package.json). Bump with `.\commands\bump-version.ps1 <version>`.
...
Unity-MCP-Plugin/Packages/AI-Game-Developer/README.md                           ← Copy of root README.md *
