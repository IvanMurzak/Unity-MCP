...
.EXAMPLE
    .\run-unity-tests.ps1 -UnityPath "C:\Program Files\Unity\Hub\Editor\2022.3.61f1\Editor\Unity.exe"
...
if (-not (Test-Path $UnityPath)) {
    ...
    Write-Host "  Example: -UnityPath `"C:\Program Files\Unity\Hub\Editor\2022.3.61f1\Editor\Unity.exe`"" -ForegroundColor Gray
    Pop-Location
    exit 1
}
